...
class first(tk.Frame):
  ...
  def __init__(self, parent, app):
    ...
    self.Image = ctk.CTkImage(light_image=Image.open("/mnt/c/Users/win10/Desktop/Finland/SP/Software_Production_2023_Axl/src/First_page_image.png"),size=(400,400))
